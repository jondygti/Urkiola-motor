...
export const USUARIOS = {
  director: { id: 'u-dir-vn', name: 'Dirección Peugeot · Citroën', role: 'director_comercial', siteIds: [], managedBrands: ['Peugeot', 'Citroën'], email: 'direccion.vn@urkiolacarservice.com', active: true },
  ...
  admin: { id: 'u-admin', name: 'Gerencia Urkiola', role: 'admin', siteIds: [], email: 'admin@urkiolacarservice.com', active: true },
  ...
  comercial: { id: 'u-juan', name: 'Juan Bilbao', role: 'comercial', siteIds: ['leioa'], email: 'juan@urkiolacarservice.com', active: true, managerId: 'u-dir-vn' },
};
