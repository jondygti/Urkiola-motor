...
export function ReceptionDetails({ reception, onDone }: { reception: Reception; onDone: (m: string) => void }) {
  ...
  const columns: Column<ReceptionLine>[] = [
    ...
    },
    {
      ...
      width: 110,
      render: (l) => (
        <Btn small disabled={!!reception.closedAt} onPress={() => setLineOpen(l)}>
          Gestionar
        </Btn>
      ),
    },
  ...
  return <>
          <Panel title="Albarán y descarga">
              ...
              <Btn
                ...
                onPress={async () => {
                  ...
                  setToast(
                    ...
                    setToast(error instanceof Error ? error.message : 'No se ha podido adjuntar el albarán.');
                  }
                }}
              >
                📷 Adjuntar albarán
            ...
            <DataTable
              ...
              onRowPress={(l) => l.vehicleId ? openVehicle(l.vehicleId) : (!reception.closedAt && setLineOpen(l))}
